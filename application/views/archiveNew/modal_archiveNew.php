<?php
// $query123 = "SELECT max(id) as kode FROM app_archive_new ";
// $i = $this->db->query($query123)->result_array();
// $b = '$kode';
// var_dump($i);
// die;
$email = $this->session->userdata('email');
$auto = "SELECT IFNULL(MAX(no_surat)+1,1) AS nomorSurat FROM app_archive_new where email='$email'";
$no = $this->db->query($auto)->row_array();

?>
<!-- New Archive Modal-->
<div class="modal fade" id="newArchiveNew" tabindex="-1" role="dialog" aria-labelledby="newArchive" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= base_url('archiveNew/view') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-danger pl-2">- Contoh Pengisian : /KEP/II.3-AU/UMSU-01/D/2020 </small>
                    </div>
                    <div class="form-group">
...
?>
    <!-- Edit Archive Modal-->
    <div class="modal fade" id="editArchiveNew<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="editArchive" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?= base_url('archiveNew/edit'); ?>">
...
?>
    <!-- Edit Archive Modal-->
    <div class="modal fade" id="uploadNew<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="editArchive" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form method="post" action="<?= base_url('archiveNew/upload'); ?>" enctype="multipart/form-data">
...
?>
    <!-- Edit Archive Modal-->
    <div class="modal fade" id="kirimArchiveNew<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="editArchive" aria-hidden="true">
